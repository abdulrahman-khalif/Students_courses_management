...
if(isset($_POST['submit'])){
    ...
    $sql_Insert_playlist = "INSERT INTO `playlist` (id, tutor_id, title, description, thumb, status) VALUES ('$id', '$tutor_id', '$title', '$description', '$rename', '$status')";
    $sql_Insert_playlist_result = $conn->query($sql_Insert_playlist);
